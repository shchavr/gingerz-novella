...
screen premain_2:
    text "{color=#FFFFFF}{size=+15}В этой игре для управления Вам понадобится{/size}{/color}" xpos .5 ypos .4 xanchor .5
    text "{color=#FFFFFF}{size=+15}мышь или тачпад.{/size}{/color}" xpos .5 ypos .45 xanchor .5
...
screen premain_3:
    text "{color=#FFFFFF}{size=+15}Мы рекомендум использовать монитор с разрешением 1920х1080 (FullHD).{/size}{/color}" xpos .5 ypos .4 xanchor .5
    text "{color=#FFFFFF}{size=+15}Не забудьте нажать F11 для перехода в полноэкранный режим.{/size}{/color}" xpos .5 ypos .45 xanchor .5
    text "{color=#FFFFFF}{size=-15}Нажмите {b}пробел{/b} или {b}левую кнопку мыши{/b}, чтобы пропустить этот экран.{/size}{/color}" xpos .5 ypos .65 xanchor .5
...
label splashscreen:
    if True: # Поменять на False, чтобы не показывать (при разработке мешает)
        ...
        pause 4.
        hide screen premain_4 with usual_transition
